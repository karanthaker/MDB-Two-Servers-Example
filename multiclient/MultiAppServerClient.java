...
Karan Thaker
MDB - Two Servers
This class is the client program for this Java EE application. It sends a message to two different JMS providers and waits for a reply.
*/
...
public class MultiAppServerClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Create temp topics for replies
            ...
            // Create consumers, set message listeners, and start connections
            ...
            // Create and send two sets of messages, one set to each app server, at 1.5-second intervals.
     ...
     // The ReplyListener class is instantiated with a set of outstanding requests.
